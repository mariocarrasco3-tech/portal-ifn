...
const CATALOGO_ACTIVIDADES_RAW = [
  ...
  {
    id: 'taller-ciudadania-digital',
    nombre: 'Taller: Ciudadanía Digital',
    grupos: ['10°C','10°D'],
    url: 'tecnologia/taller-ciudadania-digital.html',
    sub: 'Taller formativo · no calificable',
    trimestre: 2
  },
  {
  ...
  {
    id: 'word-examen-t2',
    nombre: 'Examen Final — Word 365',
    grupos: ['10°C','10°D'],
    url: 'tecnologia/word-examen-final-t2.html',
    sub: 'Examen práctico · 34 pts',
    trimestre: 2,
    tipo: 'examen',
    icon: 'ti-certificate'
  },
  {
    id: 'cyber-challenge',
    nombre: 'Cybersecurity Challenge',
    grupos: MATERIA_GRUPOS['tecnologia'],
    url: 'tecnologia/cyber-challenge.html',
    sub: 'Diagnóstico competitivo · 25 preguntas',
    trimestre: 3,
    tipo: 'quiz',
    icon: 'ti-shield-lock'
  },
  {
    id: 'examen-html',
    nombre: 'Examen Práctico HTML',
    grupos: MATERIA_GRUPOS['multimedia'],
    url: 'multimedia/examen-html.html',
    sub: 'Examen práctico · 80 pts',
    trimestre: 2,
    tipo: 'examen',
    icon: 'ti-certificate'
  },
  {
    id: 'parcial-protocolos-red',
    nombre: 'Ejercicio — Protocolos de Red',
    grupos: MATERIA_GRUPOS['multimedia'],
    url: 'multimedia/parcial-protocolos-red.html',
    sub: 'Prueba · 20 pts',
    trimestre: 2,
    icon: 'ti-file-text'
  },
  {
    id: 'ejercicio3-html1',
    nombre: 'Ejercicio — HTML #1',
    grupos: MATERIA_GRUPOS['multimedia'],
    url: 'multimedia/ejercicio3-html1.html',
    sub: 'Prueba · 15 pts',
    trimestre: 3,
    icon: 'ti-file-text'
  }
...
// Cada laboratorio construido se agrega aquí con su tema real. Se irán sumando
// uno por uno a medida que se construyan (junto con su entrada en URLS_LABS_CONSTRUIDOS).
const TEMAS_LAB = [
  'Estructura HTML, encabezados, párrafos y formato básico',
  'Encabezados y párrafos en HTML',
  'Etiquetas semánticas de HTML5 (header, nav, main, section, article, aside, footer)',
  'Listas semánticas: ul, ol y li',
  'Imágenes y rutas',
  'Audio y video'
];
...
const URLS_LABS_CONSTRUIDOS = {
  ...
  2: 'multimedia/lab-02-encabezadoyparrafos.html',
  3: 'multimedia/lab-03-etiquetas-semanticas.html',
  4: 'multimedia/lab-04-listas-semanticas.html',
  5: 'multimedia/lab-05-imagenes-rutas.html',
  6: 'multimedia/lab-06-audio-video.html'
};
const CATALOGO_LABS = TEMAS_LAB.map((tema,i)=>{
  ...
  return {
    ...
    sub: construido ? 'Laboratorio Virtual' : 'Próximamente',
    trimestre: n<=5 ? 1 : (n<=10 ? 2 : 3),
    tipo: 'laboratorio',
    construido,
    rubrica: RUBRICA_LAB_DEFAULT
  };
}).filter(l => l.construido); // solo se muestran los laboratorios ya construidos; los demás
                               // aparecerán automáticamente en cuanto se agreguen a URLS_LABS_CONSTRUIDOS
CATALOGO_ACTIVIDADES_RAW.push(...CATALOGO_LABS);

// --- Simulador de Microsoft Word 365 (Tecnología · 10°C / 10°D) ---
// Misma arquitectura que el Laboratorio Virtual de Multimedia: 10 laboratorios en el
// catálogo desde ya (para Notas del Aula), pero cada uno vive en su propio archivo
// autocontenido en tecnologia/word-lab-XX.html. Se construyen uno por uno.
const RUBRICA_WORD_LAB_DEFAULT = [
  { criterio:'Formato de texto (negrita, cursiva, subrayado, color)', pts:5 },
  { criterio:'Alineación y estructura de párrafos', pts:5 },
  { criterio:'Contenido y organización del documento', pts:5 },
  { criterio:'Dominio de herramientas de Word 365', pts:5 }
];
const TEMAS_WORD = [
  'Primeros pasos: crear y dar formato a un documento',
  'Párrafos y alineación',
  'Listas y viñetas',
  'Tablas, imágenes y ajuste de texto',
  'Encabezado, pie de página, numeración, columnas y cuadros de texto'
];
const URLS_WORD_CONSTRUIDOS = {
  1: 'tecnologia/word-lab-01.html',
  2: 'tecnologia/word-lab-02.html',
  3: 'tecnologia/word-lab-03.html',
  4: 'tecnologia/word-lab-04.html',
  5: 'tecnologia/word-lab-05.html'
};
const CATALOGO_WORD = TEMAS_WORD.map((tema,i)=>{
  const n = i+1;
  const construido = !!URLS_WORD_CONSTRUIDOS[n];
  return {
    id: 'word-lab-'+String(n).padStart(2,'0'),
    nombre: 'Word 365 · Laboratorio '+n+' — '+tema,
    materia: 'tecnologia',
    grupos: MATERIA_GRUPOS['tecnologia'],
    url: construido ? URLS_WORD_CONSTRUIDOS[n] : '#',
    sub: construido ? 'Simulador Word 365 · 20 pts' : 'Próximamente',
    trimestre: n<=3 ? 1 : (n<=7 ? 2 : 3),
    tipo: 'laboratorio',
    construido,
    rubrica: RUBRICA_WORD_LAB_DEFAULT
  };
}).filter(l => l.construido);
CATALOGO_ACTIVIDADES_RAW.push(...CATALOGO_WORD);
