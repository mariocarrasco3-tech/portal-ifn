...
// --- Recursos de práctica formativa (NO son actividades calificables) ---
// Estos NO pasan por el sistema de notas ni aparecen en el panel del docente para calificar.
// Solo se muestran como enlaces de repaso dentro de la materia correspondiente en materia.html.
const RECURSOS_FORMATIVOS = [
  {
    id: 'taller-ciudadania-digital',
    materia: 'tecnologia',
    nombre: 'Taller: Ciudadanía Digital',
    sub: 'Preguntas de desarrollo + selección múltiple · práctica formativa',
