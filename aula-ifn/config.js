...
const CATALOGO_ACTIVIDADES_RAW = [
  ...
  },
  {
    ...
    nombre: 'Parcial: Protocolos de Red',
    grupos: MATERIA_GRUPOS['multimedia'],
    url: 'multimedia/parcial-protocolos-red.html',
    sub: 'Autoevaluación · 20 pts · no calificable en panel',
    trimestre: 2,
    icon: 'ti-file-text'
  },
  {
    id: 'ejercicio3-html1',
    nombre: 'Ejercicio #3 — HTML #1',
    grupos: MATERIA_GRUPOS['multimedia'],
    url: 'multimedia/ejercicio3-html1.html',
    sub: 'Autoevaluación · 15 pts · no calificable en panel',
    trimestre: 3,
    icon: 'ti-file-text'
  }
];
